...
import LogoImage from "@/assets/images/logo/Negativo.png";
import LogoSelo from "@/assets/images/logo/Selo.png";
...
export default function StaticSidebar({ isOpen, isMinimized, toggleSidebar, minimizeSidebar, isMobile }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="h-[calc(100vh-4rem)] overflow-y-auto py-4 sidebar-scroll">
