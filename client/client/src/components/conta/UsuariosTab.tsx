...
import { AlertTriangle, Edit, Lock, Plus, PlusCircle, Save, Shield, Trash, Trash2, User, UserPlus, X } from "lucide-react";
    ...
    <Card className="shadow-sm">
      ...
      <CardContent>
        <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center mb-4 gap-2">
          <div>
            <h3 className="text-base font-medium">Usuários cadastrados</h3>
            <p className="text-xs text-gray-500 mt-1">Adicione, edite ou remova usuários do sistema</p>
          </div>
          {!showAddUser && (
            <Button 
              onClick={() => {
                ...
                // Resetar estados de validação ao abrir novo formulário
                    setCamposUsuarioValidados({
                      nome: true,
                      email: true,
                      setor: true,
