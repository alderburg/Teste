...
import { PlusCircle, Edit3, Trash2, Save, X, Building, CheckCircle, AlertTriangle, Loader2, Phone, Mail, User, Briefcase, Smartphone } from "lucide-react";
    ...
    <Card className="shadow-sm">
      ...
      <CardContent>
        <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center mb-4 gap-2">
          <div>
            <h3 className="text-base font-medium">Contatos cadastrados</h3>
            <p className="text-xs text-gray-500 mt-1">Adicione, edite ou remova contatos</p>
          </div>
          {!showAddContato && (
            <Button 
              onClick={() => {
                ...
                // Resetar estado de validação ao abrir o formulário
                setCamposContatoValidados({
                  nome: true,
                  setor: true,
                  email: true,
        ...
        {!showAddContato && (
          <>
            ...
            ) : contatosData && contatos.length === 0 ? (
              <div className="flex flex-col items-center justify-center p-8 text-center">
