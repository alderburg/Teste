...
export default function LandingPage() {
  ...
  // Adicionar atributo de identificação da landing page
  useEffect(() => {
    document.body.setAttribute('data-current-page', 'landing');
    document.documentElement.setAttribute('data-current-page', 'landing');
    ...
    >
      ...
      <section id="prejuizo" className="py-20 bg-white overflow-hidden relative scroll-mt-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          {/* Seção de História - Storytelling  */}
          <div className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen">
            <section
              id="destaques"
              className="w-screen py-8 storytelling-bg"
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
              ...
              <div className="text-center mb-4 pt-4">
                ...
                <motion.p
                  className="text-sm md:text-base text-white/80 mx-auto max-w-2xl mb-6 md:mb-10 text-center"
                  initial={{ opacity: 0 }}
              ...
              <div className="hidden md:flex md:flex-row max-w-6xl mx-auto items-stretch">
                {/* Coluna esquerda - Conteúdo do storytelling */}
                <div className="md:w-3/5 md:pr-8 flex">
                  {/* Caixa translúcida para o texto */}
                  <motion.div
                    className="bg-purple-950/70 backdrop-blur-sm rounded-xl p-6 shadow-xl border border-purple-700/30 text-left h-full flex flex-col justify-between"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                        ...
                        <div className="flex justify-center mt-3">
                          ...
                          >
                            ...
                            >
                              ...
                              <ChevronRight className="ml-100 h-3 w-3" />
                            </BotaoAutenticacao>
                          </motion.div>
                        </div>
                      </div>
                ...
                {/* Coluna direita - Foto do empresário e cards informativos */}
                <div className="md:w-2/5 flex flex-col items-center justify-start md:pl-8 h-full">
                  {/* Foto do empresário */}
                  <motion.div 
                  ...
                  <div className="space-y-4 w-full max-w-sm">
                    ...
                    <motion.div 
                      className="bg-indigo-800/50 backdrop-blur-sm rounded-lg p-4 border border-indigo-700"
                    ...
                    >
                      <div className="flex items-center mb-2">
                        ...
                        <h4 className="text-white font-semibold text-sm">Crescimento Empresarial</h4>
                      </div>
                      <p className="text-white/90 text-xs">
                        Em 12 meses: de <span className="text-red-300 font-bold">-R$ 200k</span> em dívidas para 
                        <span className="text-green-300 font-bold"> +R$ 1,5mi</span> em valor de empresa
                      </p>
                    </motion.div>
                    
                    {/* Card de estatística 2 */}
                    <motion.div 
                      className="bg-purple-800/50 backdrop-blur-sm rounded-lg p-4 border border-purple-700"
                      initial={{ opacity: 0, x: 20 }}
                      whileInView={{ opacity: 1, x: 0 }}
                      viewport={{ once: true }}
                    ...
                    >
                      <div className="flex items-center mb-2">
                        ...
                        >
                          <Calculator className="h-5 w-5 text-yellow-300 mr-2" />
                        </motion.div>
                        <h4 className="text-white font-semibold text-sm">Precificação Estratégica</h4>
                      </div>
                      <p className="text-white/90 text-xs">
                        <span className="text-yellow-300 font-bold">Sistema próprio</span> desenvolvido para calcular 
                        preços com <span className="text-cyan-300 font-bold">precisão matemática</span> e garantir lucro real
                      </p>
                    </motion.div>
                    
                    {/* Card de impacto */}
                    <motion.div 
                      className="bg-gradient-to-r from-green-800/60 to-emerald-800/60 backdrop-blur-sm rounded-lg p-4 border border-green-600/50"
                      initial={{ opacity: 0, x: 20 }}
                      whileInView={{ opacity: 1, x: 0 }}
                      viewport={{ once: true }}
                    ...
                    >
                      <div className="flex items-center mb-2">
                        ...
                        <h4 className="text-white font-semibold text-sm">Missão do Sistema</h4>
                      </div>
                      <p className="text-white/90 text-xs">
                        Evitar que outros empresários passem pelo que eu passei. 
                        <span className="text-green-300 font-bold"> Ferramentas certas</span> para 
                        <span className="text-yellow-300 font-bold"> resultados certos</span>.
                      </p>
                    </motion.div>
                  </div>
                </div>
              ...
              <div className="md:hidden max-w-5xl mx-auto text-center">
