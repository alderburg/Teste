              ...
              {isMobile ? (
                  ...
                  {isSearchExpanded ? (
                    ...
                    >
                      <input
                        ...
                        className="w-full h-10 rounded-md border border-gray-300 bg-white px-4 py-2 pl-10 text-sm focus:border-primary focus:outline-none focus:ring-0"
                        value={searchTerm}
                    ...
                    <motion.button
                      className="rounded-full p-2 hover:bg-gray-100 transition-colors h-10 w-10 flex items-center justify-center"
                ...
                <AnimatePresence initial={false}>
                  {isSearchExpandedDesktop ? (
                    ...
                    <motion.button
                      className="rounded-full p-2 hover:bg-gray-100 transition-colors ml-auto h-10 w-10 flex items-center justify-center"
